...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container">
            <a href="#" class="navbar-brand"><span class="text-success">Contraloria</span> <span
                    class="text-warning">General</span> del Risaralda</a>
            ...
            <div class="collapse navbar-collapse" id="navbar-start">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.contraloriarisaralda.gov.co/">Web</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://accounts.google.com/AccountChooser/signinchooser?service=mail&continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&flowName=GlifWebSignIn&flowEntry=AccountChooser&ec=asw-gmail-globalnav-signin&ddm=1">Correo
                            electronico</a>
                    </li>
                </ul>
                    ...
                    <div class="card text-white text-center bg-car1 pb-2">
                        <div class="card-body">
                            ...
                            <a href="https://sites.google.com/contraloriarisaralda.gov.co/menuprincipal/inicio?authuser=4&pli=1"
                                class="btn btn-success">IR A INTRANET</a>
                ...
                <div class="col-12 col-md-12 col-lg-4 mb-3">
                    <div class="card text-white text-center bg-car2 pb-2">
                        <div class="card-body">
                            ...
                            <a href="https://sites.google.com/ticcontraloriarisaralda.com/intranetvisitantes/transparencia-y-acceso-a-la-informaci%C3%B3n"
                                class="btn btn-primary">IR A INTRANET</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-12 col-lg-4 mb-3">
                    <div class="card text-white text-center bg-car3 pb-2">
                        <div class="card-body">
                            ...
                            <button class="btn bg-success text-white">IR A DATOS</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-mb-12 col-lg-4 box-icons">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-4">
                            <h3>Envio Gratis</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos, cumque? In nam
                            </p>
                ...
                <div class="col-md-12">
                    <div class="section-header text-center pb-5">
                        ...
                        <p>En esta sección, encontrarás los accesos directos a las aplicaciones de trabajo.<br>
                            Solo tienes que hacer clic en el botón 'Ir</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md col-lg-3">
                    <div class="card bg-light shadow-sm border-0 px-2 py-3 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://siacontralorias.auditoria.gov.co/" class="btn btn-success">Abrir</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md col-lg-3">
                    <div class="card bg-light shadow-sm border-0 px-2 py-3 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://portal.paco.gov.co/" class="btn btn-success">Abrir</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md col-lg-3">
                    <div class="card bg-light shadow-sm border-0 px-2 py-3 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://saintweb.com.co/sicof/" class="btn btn-success">Abrir</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md col-lg-3">
                    <div class="card bg-light shadow-sm border-0 px-2 py-3 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://servicio.siifweb.com/" class="btn btn-success">Abrir</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md col-lg-3">
                    <div class="card bg-light shadow-sm border-0 px-2 py-3 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <p>Comité de convivencia laboral
                            </p>
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdP4R9mvqReLd13L_uHQYv8xu0uHyzuA-ppg4w9lA_Fv0t58Q/viewform"
                                class="btn btn-success">Abrir</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-header text-center pb-2 pb-lg-5">
                        <h2>contacto</h2>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laboriosam alias consequuntur
                            maiores excepturi quo architecto numquam nam! Ab, aspernatur nostrum laboriosam ducimus vero
                            maxime tempora maiores, quae voluptatem expedita aut.
                        </p>
                    ...
                    <div class="col-12 col-md-12 col-lg-6 pt-4 pb-4">
                        <form action="#" class="bg-light p-4 m-auto shadow-sm">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <textarea class="form-control" placeholder="mensaje" rows="3"
                                            required></textarea>
                                    </div>

                                </div>

                                <button class="btn btn-primary btn-lg mt-3" type="button">Enviar</button>
